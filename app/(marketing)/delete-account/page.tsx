...
export const metadata = pageMetadata({
  ...
  description:
    'How to permanently delete your Werdsmith account and all associated data, from inside the app or by email.',
  path: '/delete-account',
});
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-20">
      ...
      <p className="mt-2 text-sm text-stone">
        How to permanently delete your Werdsmith account and the data that goes with it.
      </p>
      ...
      <div className="mt-10 space-y-8 text-stone">
        <section>
          ...
          <ol className="mt-3 list-decimal space-y-2 pl-5">
            <li>Open the Werdsmith app and go to the <span className="font-medium text-ink">Settings</span> tab.</li>
            <li>
