...
export const metadata = pageMetadata({
  ...
  description:
    'The terms that govern your use of the Werdsmith X Android writing app and website, including your account, your content, and subscriptions.',
  path: '/terms',
});
      ...
      <div className="mt-10 space-y-8 text-stone">
        <section>
          <p className="leading-relaxed">
            These Terms of Service (&quot;Terms&quot;) govern your use of the Werdsmith X Android
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            You retain full ownership of everything you write in Werdsmith X. By using the Service,
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            Werdsmith X&apos;s core editor is free. Free accounts can create up to 2 projects and use
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            ...
            fullest extent permitted by law, Werdsmith X is not liable for any indirect, incidental,
